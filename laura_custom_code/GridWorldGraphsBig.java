...
public class GridWorldGraphsBig {
    ...
    public GridWorldGraphsBig() {
        gwdg = new GridWorldDomain(50, 50);

        //Make some walls
        int[][] map = gwdg.getMap();
        gwdg.horizontalWall(0,8,10);
        gwdg.horizontalWall(10,49,10);
        gwdg.horizontalWall(0,22,20);
        gwdg.horizontalWall(24,49,20);
        gwdg.horizontalWall(0,45,30);
        gwdg.horizontalWall(47,49,30);
        gwdg.horizontalWall(0,9,40);
        gwdg.horizontalWall(11,49,40);
        ...
        tf = new GridWorldTerminalFunction(49,49);
        goalCondition = new TFGoalCondition(tf);

        //set up the initial state of the task
        initialState = GridWorldDomain.getOneAgentOneLocationState(domain);
        GridWorldDomain.setAgent(initialState, 0, 0);
        GridWorldDomain.setLocation(initialState, 0, 49, 49);
    ...
    public static void main(String[] args) {
        GridWorldGraphsBig example = new GridWorldGraphsBig();
